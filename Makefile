...
# DEFAULT_ANVIL_ACCOUNT := AnvilDefaul1
...
sign :; 
	@cast wallet sign --no-hash --account $(DEFAULT_ANVIL_ACCOUNT) ${shell cast call ${AIRDROP_ADDRESS} "getMessageHash(address,uint256)" ${DEFAULT_ANVIL_ADDRESS} ${AIRDROP_AMOUNT} --rpc-url http://localhost:8545}
